...
class StudySession(models.Model):
    ...
    subject_name = models.CharField(max_length=100, blank=True)  # ДУБЛИРУЮЩЕЕ ПОЛЕ
    ...
    def save(self, *args, **kwargs):
        """Автоматически заполняем subject_name при сохранении"""
        if self.subject:
...
# Остальной код SessionParticipant без изменений
